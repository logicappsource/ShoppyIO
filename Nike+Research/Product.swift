...
//  Nike+Research
//
//  Created by LogicAppSourceIO on 16/06/2017.
...
class Product { //Value type - pass aroun, assign copy value of the intance itself
    ...
    init(uid: String? , name: String? , images: [UIImage]?, price: Double?, description: String?, detail: String?, relatedProductUIDs: [String]? = ["875942-100", "880843-003", "384664-113", "8055144-852"])
    {
        self.uid = uid
        self.name = name
        self.images = images
